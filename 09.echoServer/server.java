...
====== ( first compile server then client in separate terminal ) =====

darsana@user-HP-280-G3-MT:~/Desktop/OSLab/exp9$ javac client.java
darsana@user-HP-280-G3-MT:~/Desktop/OSLab/exp9$ java client
Enter the message to the server:Hi Message from client                        
Return message from server :Hi Message from client

darsana@user-HP-280-G3-MT:~/Desktop/OSLab/exp9$ javac server.java
darsana@user-HP-280-G3-MT:~/Desktop/OSLab/exp9$ java server
